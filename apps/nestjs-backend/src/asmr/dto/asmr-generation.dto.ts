...
export class VoiceSettings {
  ...
  @ApiPropertyOptional({ minimum: 0.5, maximum: 2.0, description: 'Voice speed multiplier' })
  @IsOptional()
  @IsNumber()
  @Min(0.5)
  @Max(2.0)
  ...
  @ApiPropertyOptional({ minimum: 0.1, maximum: 1.0, description: 'Voice volume' })
  @IsOptional()
  @IsNumber()
  @Min(0.1)
  @Max(1.0)
...
export class SoundscapeSettings {
  ...
  @ApiPropertyOptional({ minimum: 0.0, maximum: 1.0, description: 'Soundscape volume' })
  @IsOptional()
  @IsNumber()
  @Min(0.0)
  @Max(1.0)
...
export class MixingSettings {
  ...
  @ApiPropertyOptional({ minimum: 0.0, maximum: 1.0, description: 'Master volume' })
  @IsOptional()
  @IsNumber()
  @Min(0.0)
  @Max(1.0)
