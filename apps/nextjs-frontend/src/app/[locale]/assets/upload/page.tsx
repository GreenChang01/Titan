...
import {Package, Upload, FileAudio, FileText, FileImage, FileVideo, X, Check, AlertCircle} from 'lucide-react';
...
export default function AssetsUploadPage(): JSX.Element {
	...
	const getFileIcon = (file: File) => {
		if (file.type.startsWith('audio/')) return <FileAudio className="h-8 w-8 text-blue-500"/>;
														...
														<div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-3">
															<div className="space-y-2">
																...
																<Select
																	...
																	onValueChange={(value) => updateFileInfo(fileItem.id, 'category', value)}
																>
															...
															<div className="space-y-2">
																...
																<Input
																	...
																	onChange={(e) => updateFileInfo(fileItem.id, 'description', e.target.value)}
																/>
															</div>
														</div>
													)}
