...
export function Step2Voice(): JSX.Element {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* 高级语音设置 */}
      {formData.voiceSettings?.voiceId ? <Card>
        <CardHeader>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <Slider
              ...
              step={0.05}
              className="w-full"
              onValueChange={([value]) => { handleVoiceChange('stability', value); }}
            />
          ...
          <div className="space-y-3">
            ...
            <Slider
              ...
              step={0.05}
              className="w-full"
              onValueChange={([value]) => { handleVoiceChange('similarity', value); }}
            />
          ...
          <div className="space-y-3">
            ...
            <Slider
              ...
              step={0.05}
              className="w-full"
              onValueChange={([value]) => { handleVoiceChange('style', value); }}
            />
