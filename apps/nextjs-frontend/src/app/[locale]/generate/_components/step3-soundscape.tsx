        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <Slider
              ...
              step={30}
              className="w-full"
              onValueChange={(value) => { handleCustomSettingChange('duration', value[0]); }}
            />
          ...
          <div className="space-y-3">
            ...
            <Select
              ...
              onValueChange={(value) => { handleCustomSettingChange('category', value); }}
            >
              <SelectTrigger>
          ...
          <div className="space-y-3">
            ...
            <Slider
              ...
              step={1}
              className="w-full"
              onValueChange={(value) => { handleCustomSettingChange('intensity', value[0]); }}
            />
            <div className="flex justify-between text-xs text-muted-foreground">
              <span>轻柔</span>
              <span>强烈</span>
          ...
          <div className="space-y-3">
            ...
            <Select
              ...
              onValueChange={(value) => { handleCustomSettingChange('quality', value as 'standard' | 'high' | 'premium'); }}
            >
              <SelectTrigger>
