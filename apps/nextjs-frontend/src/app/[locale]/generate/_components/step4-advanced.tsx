...
import {Settings, Volume2, Headphones, Zap, Info, Loader2} from 'lucide-react';
...
export function Step4Advanced(): JSX.Element {
  ...
  const handleMixingChange = (field: keyof MixingSettings, value: any) => {
    setLocalMixingSettings((prev) => ({...prev, [field]: value}));
  ...
  const handleQualityChange = (field: keyof QualityRequirements, value: any) => {
    setLocalQualitySettings((prev) => ({...prev, [field]: value}));
  };
    ...
    <div className="space-y-6">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <Slider
                  ...
                  step={0.05}
                  className="w-full"
                  onValueChange={(value) => { handleMixingChange('voiceVolume', value[0]); }}
                />
              </div>
              ...
              <div className="space-y-3">
                ...
                <Slider
                  ...
                  step={0.05}
                  className="w-full"
                  onValueChange={(value) => { handleMixingChange('soundscapeVolume', value[0]); }}
                />
              </div>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <Slider
                  ...
                  step={0.5}
                  className="w-full"
                  onValueChange={(value) => { handleEQChange('lowFreq', value[0]); }}
                />
              </div>
              ...
              <div className="space-y-3">
                ...
                <Slider
                  ...
                  step={0.5}
                  className="w-full"
                  onValueChange={(value) => { handleEQChange('midFreq', value[0]); }}
                />
              </div>
              ...
              <div className="space-y-3">
                ...
                <Slider
                  ...
                  step={0.5}
                  className="w-full"
                  onValueChange={(value) => { handleEQChange('highFreq', value[0]); }}
                />
              </div>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <Slider
                  ...
                  step={0.1}
                  className="w-full"
                  onValueChange={(value) => { handleQualityChange('minimumScore', value[0]); }}
                />
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => { handleQualityChange('enableAutoRetry', checked); }}
                />
              </div>

              {/* Max Retries */}
              {qualitySettings.enableAutoRetry ? <div className="space-y-3">
                <div className="flex items-center justify-between">
                ...
                <Slider
                  ...
                  step={1}
                  className="w-full"
                  onValueChange={(value) => { handleQualityChange('maxRetries', value[0]); }}
                />
              </div> : null}
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => { handleQualityChange('strictValidation', checked); }}
                />
              </div>
            </CardContent>
          </Card>
      ...
      <Card className="bg-muted/50 border-muted">
        <CardContent className="pt-6">
          ...
          {selectedPreset ? <div className="mt-3 pt-3 border-t border-muted">
