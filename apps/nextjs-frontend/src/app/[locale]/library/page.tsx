...
import {
	Library, Play, Download, Clock, FileAudio, Search, Filter, Grid, List, MoreVertical,
} from 'lucide-react';
...
export default function LibraryPage(): JSX.Element {
	...
	const categories = ['all', ...new Set(mockAudioContent.map(item => item.category))];
	...
	function AudioCard({content}: {readonly content: AudioContent}) {
		return (
	...
	function AudioListItem({content}: {readonly content: AudioContent}) {
		return (
		...
		<>
			<Header>
				<div className='flex items-center justify-between w-full'>
					...
					<div className='flex items-center gap-2'>
						<Button
							variant='outline' size='sm' className={viewMode === 'grid' ? 'bg-muted' : ''}
							onClick={() => {
								setViewMode('grid');
							}}
						>
						...
						<Button
							variant='outline' size='sm' className={viewMode === 'list' ? 'bg-muted' : ''}
							onClick={() => {
								setViewMode('list');
							}}
						>
						...
						<CardContent className='pt-6'>
							<div className='flex flex-col md:flex-row gap-4'>
								...
								<div className='flex gap-2'>
									...
									<Select
										value={sortBy} onValueChange={(value: any) => {
											setSortBy(value);
										}}
									>
