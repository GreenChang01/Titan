				...
				<div className="text-center mb-8">
					<div className="flex items-center justify-center gap-4 mb-4">
						...
						<Button 
							variant="outline" 
							size="sm"
							onClick={() => window.location.href = '/ai-studio/images'}
						>
								...
								<div className="space-y-2">
									...
									<div className="grid grid-cols-4 gap-2">
										{[512, 768, 1024, 1536].map(size => (
											<button
												key={size}
												onClick={() => setSettings(prev => ({...prev, width: size, height: size}))}
												className={cn(
								...
								<div className="grid grid-cols-2 gap-4">
									<div className="flex items-center justify-between">
										...
										<Switch
											...
											onCheckedChange={(checked) => setSettings(prev => ({...prev, enhance: checked}))}
										/>
									</div>
									<div className="flex items-center justify-between">
										...
										<Switch
											...
											onCheckedChange={(checked) => setSettings(prev => ({...prev, private: checked}))}
										/>
									</div>
								</div>
							</CardContent>
						...
						<Card className="border-0 shadow-lg">
							<CardHeader>
								<div className="flex items-center justify-between">
									...
									<div className="flex items-center gap-2">
										<Button size="sm" variant="ghost" onClick={() => handleQuickAction('download')}>
											<Download className="w-4 h-4" />
										</Button>
										<Button size="sm" variant="ghost" onClick={() => handleQuickAction('copy')}>
											<Copy className="w-4 h-4" />
										</Button>
										<Button size="sm" variant="ghost" onClick={() => handleQuickAction('favorite')}>
