...
const mockAssets: AIImageAsset[] = [
	{
		...
		metadata: {
			width: 1024, height: 1024, size: '2.1MB', format: 'JPG', model: 'pollinations', seed: 12_345,
		},
		isFavorite: true,
		isPrivate: false,
		views: 156,
	...
	},
	{
		...
		metadata: {
			width: 1024, height: 1024, size: '1.8MB', format: 'JPG', model: 'pollinations', seed: 67_890,
		},
		isFavorite: false,
		isPrivate: false,
		views: 89,
	...
	},
	{
		...
		metadata: {
			width: 1024, height: 1024, size: '2.3MB', format: 'JPG', model: 'pollinations', seed: 11_111,
		},
		isFavorite: true,
		isPrivate: true,
		views: 234,
	...
	},
	{
		...
		metadata: {
			width: 1024, height: 1024, size: '1.9MB', format: 'JPG', model: 'pollinations', seed: 22_222,
		},
		isFavorite: false,
		isPrivate: false,
		views: 67,
			...
			<div className='flex h-full'>
				...
				<div className='flex-1 overflow-hidden'>
					...
					<div className='border-b bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm px-4 py-3'>
						...
						{/* Filters */}
						{showFilters ? <div className='border-t p-4 bg-gray-50/50 dark:bg-gray-800/50'>
							<div className='grid grid-cols-4 gap-4'>
								<div>
									<Label className='text-sm mb-2'>排序方式</Label>
									<Select
										value={filters.sortBy} onValueChange={value => {
								...
								<div>
									...
									<Select
										value={filters.dateRange} onValueChange={value => {
								...
								<div>
									...
									<Select
										value={filters.isPrivate ? 'private' : 'all'} onValueChange={value => {
											setFilters(prev => ({...prev, isPrivate: value === 'private'}));
										}}
									>
					...
					<ScrollArea className='flex-1 p-4'>
						<div className={cn(viewMode === 'grid' ? 'grid grid-cols-3 gap-4' : 'space-y-2')}>
