...
const SidebarContext = React.createContext<SidebarContextProps | undefined>(null);
...
function SidebarGroupLabel({className, asChild = false, ...props}: React.ComponentProps<'div'> & {readonly asChild?: boolean}) {
