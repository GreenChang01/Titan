...
import {authApi, projectsApi, aliyunDriveApi,
  type LoginRequest,
  ...
  type SyncResult,
  type AddToProjectResult} from '@/lib/api.js';
...
// Project hooks
export function useProjects(params?: ProjectListParams): UseQueryResult<ProjectListResponse, Error> {
  return useQuery({
    queryKey: queryKeys.projects.list(params ?? {}),
    queryFn: async () => projectsApi.getProjects(params),
  });
}
...
export function useProjectActivities(projectId: string, params?: {page?: number; limit?: number}): UseQueryResult<ProjectActivity[], Error> {
  return useQuery({
    queryKey: queryKeys.projects.activities(projectId),
    queryFn: async () => projectsApi.getProjectActivities(projectId, params),
...
export function useAliyunDriveFiles(params?: FileListParams): UseQueryResult<DirectoryContent, Error> {
  return useQuery({
    queryKey: queryKeys.aliyunDrive.fileList(params ?? {}),
    queryFn: async () => aliyunDriveApi.getFiles(params),
